                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group{{ $errors->has('firstname') ? ' has-error' : '' }} required">
                                    ...
                                    <div class="col-md-6">
                                        <input id="firstname" type="text" class="form-control" name="firstname" value="{{ $data['ibo']['firstname'] }}" required>
                                ...
                                <div class="form-group{{ $errors->has('middlename') ? ' has-error' : '' }} required">
                                    ...
                                    <div class="col-md-6">
                                        <input id="middlename" type="text" class="form-control" name="middlename" value="{{ $data['ibo']['middlename'] }}" required>
                                ...
                                <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }} required">
                                    ...
                                    <div class="col-md-6">
                                        <input id="lastname" type="text" class="form-control" name="lastname" value="{{ $data['ibo']['lastname'] }}" required>
