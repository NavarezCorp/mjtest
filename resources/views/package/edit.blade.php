                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/package/' . $data['info']->id) }}">
                        ...
                        <div class="form-group{{ $errors->has('activation_code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="activation_code" value="{{ $data['info']->activation_code }}" readonly>
                        ...
                        <div class="form-group{{ $errors->has('used_by_ibo_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="used_by_ibo_id" value="{{ $data['info']->used_by_ibo_id }}">
                        ...
                        <div class="form-group{{ $errors->has('encoded_by_ibo_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="encoded_by_ibo_id" value="{{ $data['info']->encoded_by_ibo_id }}">
                        ...
                        <div class="form-group{{ $errors->has('is_used') ? ' has-error' : '' }}">
                            <div class="col-md-6 col-md-offset-4">
                                <div class="checkbox" style="float:left; margin-right:30px;">
                                    <label>
                                        <input type="checkbox" name="is_used"> Is Used
                                    </label>
                                </div>
                            </div>
                        </div>
